...
| **Primary Use Case** | Data warehousing, BI |
| **Strengths** | Separation of compute and storage |
| **Weaknesses** | Cost, not for real-time |
| **Best For** | Enterprise analytics |
| **Never Use When** | Sub-second latency requirements |
| **Max Scale** | Petabytes |
