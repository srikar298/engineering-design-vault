...
| **Primary Use Case** | Data warehousing |
| **Strengths** | Integration with AWS |
| **Weaknesses** | Tightly coupled storage/compute |
| **Best For** | AWS ecosystem analytics |
| **Never Use When** | Unstructured data |
| **Max Scale** | Petabytes |
