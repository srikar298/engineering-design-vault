...
| **Primary Use Case** | Serverless analytics |
| **Strengths** | Zero management, highly scalable |
| **Weaknesses** | Cost predictability |
| **Best For** | Ad-hoc queries on massive datasets |
| **Never Use When** | Frequent small updates |
| **Max Scale** | Exabytes |
