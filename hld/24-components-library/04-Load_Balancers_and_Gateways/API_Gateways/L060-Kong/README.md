...
| **Category** | LB |
| **Type** | API Gateway |
| **Primary Use Case** | API Management |
| **Strengths** | High performance, plugins |
| **Weaknesses** | Lua knowledge for custom plugins |
| **Best For** | Microservices routing |
| **Never Use When** | Simple monoliths |
| **Max Scale** | High |
