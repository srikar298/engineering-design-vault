...
| **Primary Use Case** | Legacy big data |
| **Strengths** | Fault tolerance, mature |
| **Weaknesses** | Disk I/O bound, slow |
| **Best For** | Massive batch jobs |
| **Never Use When** | Interactive queries |
| **Max Scale** | Petabytes |
